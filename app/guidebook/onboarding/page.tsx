    ...
    <>
      <div className="onboarding-page">
        ...
        <header className="onboarding-header">
          ...
          <h1 className="page-title">위•해촉 안내</h1>
        </header>
        ...
        <div className="process-tabs-container">
          <div className="container">
            <div className="process-tabs">
              <button
                className={`process-tab experienced ${expandedProcess === 'experienced' ? 'active' : ''}`}
                onClick={() => toggleProcess('experienced')}
              >
                경력자 위촉
              </button>
              <button
                className={`process-tab inexperienced ${expandedProcess === 'inexperienced' ? 'active' : ''}`}
                onClick={() => toggleProcess('inexperienced')}
              >
                무경력자 위촉
              </button>
            </div>
